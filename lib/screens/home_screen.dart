...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final TextEditingController _scheduleCodeController =
  ...
  final List<Map<String, dynamic>> _modes = [
    {
      ...
      'desc': 'Reunions generales'
    },
    {
      'id': 'church',
      'label': 'Eglise',
      'icon': Icons.church,
      'color': AppColors.church,
      'desc': 'Culte live, offrandes'
    },
    {
      'id': 'education',
      'label': 'Formation',
  ...
  void _createMeeting() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Creation de la reunion...'),
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                if (_scheduleTitleController.text
                    .trim()
                    .isEmpty) return;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (meeting.scheduledAt != null)
                        Text(
                          '${meeting.scheduledAt!.day}/${meeting.scheduledAt!.month}/${meeting.scheduledAt!.year} ${meeting.scheduledAt!.hour.toString().padLeft(2, '0')}:${meeting.scheduledAt!.minute.toString().padLeft(2, '0')}',
                          style: const TextStyle(
                              color: AppColors.grey,
                              fontSize: 12),
                        ),
